...
let gameState = {
  ...
  function checkBottleCollection() {
    ...
    if (bottleIndex !== -1) {
      ...
      const seal = document.getElementById("seal");
      seal.className = `seal fat-${gameState.bottlesCollected}`;
  ...
  function updateIceCracking() {
    ...
    //   if (timeProgress > 0.25) board.classList.add("ice-cracking-1");
  
    const tiles = document.querySelectorAll(".ice-tile");
    tiles.forEach((tile) => {
      tile.className = "ice-tile";
  
      // if (timeProgress > 0.25) tile.classList.add("ice-cracking-1");
      // if (timeProgress > 0.5) tile.classList.add("ice-cracking-2");
      // if (timeProgress > 0.75) tile.classList.add("ice-cracking-3");
      // if (timeProgress >= 1) tile.classList.add("ice-broken");
    });
  }
  ...
  function endGame(won) {
    ...
    if (!won) {
      ...
      // const tiles = document.querySelectorAll(".ice-tile");
      // tiles.forEach((tile) => tile.classList.add("ice-broken"));
